...
export default function Navbar() {
  ...
  return (
    <>
      {/* Announcement Bar */}
      <div className="fixed top-0 left-0 w-full bg-lime-700 text-white z-[60] overflow-hidden">
        <div className="marquee tracking-wider">
          <div className="marquee-content max-md:!pr-35">
            🚚 Get free delivery within Lagos when you purchase 5 or more!
          </div>
          <div className="marquee-content max-md:!pr-35">
            🚚 Get free delivery within Lagos when you purchase 5 or more!
          </div>
      ...
      {/* Navbar */}
      <nav className="fixed top-10 w-full max-w-[1600px] z-50 max-md:px-2 bg-white/20 backdrop-blur-md shadow-sm">
        <div className="flex justify-between items-center px-4 py-3.25 md:px-8">
          {/* Logo */}
